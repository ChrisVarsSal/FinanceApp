            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-lg p-6 sticky top-6">
                <div className="text-center mb-6">
                  <div className="relative inline-block mb-4 profile-avatar">
                    <img
                      src={profilePicture}
                      alt="Profile"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      value={
                        isEditing ? tempUserInfo.firstName : userInfo.firstName
                      }
                      onChange={(e) =>
                        setTempUserInfo({
                          ...tempUserInfo,
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={
                        isEditing ? tempUserInfo.lastName : userInfo.lastName
                      }
                      onChange={(e) =>
                        setTempUserInfo({
                          ...tempUserInfo,
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={
                        isEditing ? tempUserInfo.username : userInfo.username
                      }
                      onChange={(e) =>
                        setTempUserInfo({
                          ...tempUserInfo,
